...
class TestConfigList:
    def test_lists_all_keys_as_defaults(self, temp_home, capsys):
        ...
        for key in (
            ...
            "autoswitch.failbackDelaySeconds",
    ...
    def test_json_list(self, temp_home, capsys):
        ...
        assert by_key["autoswitch.failbackDelaySeconds"]["value"] is None
        assert by_key["autoswitch.failbackDelaySeconds"]["isSet"] is False
