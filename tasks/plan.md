...
- [ ] Task 6: All panel actions end-to-end (switch/rotate/best/disable/enable/remove/add/auto-switch/prefs)
- [ ] Task 7: Stale, error, quarantine, and webview-failure states
